...
int main()
{
    ...
    {
        if(!(i%3)) a[i].PB(i/3), a[i].PB(0), a[i].PB(0);
        else if(!(i%5)) a[i].PB(0), a[i].PB(i/5), a[i].PB(0); 
        else if(!(i%7)) a[i].PB(0), a[i].PB(0), a[i].PB(i/7);
        else if(i%3==1 && i>9) a[i].PB(i/3-2), a[i].PB(0), a[i].PB(1);
        else if(i%3==2 && i>7) a[i].PB(i/3-1), a[i].PB(1), a[i].PB(0);
        else a[i].PB(-1);
    }
    // t=1;
    while(t--)
