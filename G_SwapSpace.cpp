...
bool cmp(pair<ll, ll>a, pair<ll, ll>b)
{
    ...
    // return max(a.first, a.first+b.firs t-a.second)<max(b.first, b.first+a.first-b.second);
}
...
int main()
{
    ...
    do
    {
        vector<pair<ll,ll>>drive;
        ll a, b, an=0, ex=0, used=0, tot=0;
        FOR(i, n, 1)
        {
            cin>> a>> b;
            drive.PB({a,b});
        }
        sort(drive.begin(), drive.end(), cmp);

        FOR(i, n, 1)
        {
            an+= max(0LL, drive[i].first-an-tot+used);
            ex+= drive[i].second-drive[i].first;
			used+=drive[i].first;
			tot+=drive[i].second;
        }
