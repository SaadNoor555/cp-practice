...
https://atcoder.jp/contests/abc133/tasks/abc133_c?lang=en                                                                       ---.   `                     
                                                                      :dmms  /dho`                  
                                                                      ymmmo  ymmh`.///`             
                                                                     .dmmm+-:mmms +mmd`             
                                                ````                 :mmmmmddmmm/ .:-.              
...
#define FOR(iterator, in,  limit, adder) for(ll iterator=in; iterator<limit; iterator+=adder)
...
void foo(int cnt)
{
    ...
    FOR(i, l, min(l+2020, r+1), 1)
        FOR(j, i+1, min(l+2020, r+1), 1)
