...
int main()
{
    ...
    while(t--)
    {
        ...
        FOR(i, n1, 1)
        {
            ...
            f= upper_bound(a[kj].begin(), a[kj].end(), a[ki][i])-a[kj].begin(); 

            an+=(s[kj][n2-1]+a[ki][i]*f-a[ki][i]*(n2-f));
